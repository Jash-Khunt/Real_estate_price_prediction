...
_Figure 1: Comparison of R² Score and Error Metrics across proposed models._
...
_Figure 2: Top features influencing the price prediction in the Random Forest model._
...
_Figure 3: Accuracy analysis (Actual vs Predicted Prices) showing the model's reliability._
...
- **RQ2 Answer**: Feature importance and correlation analysis confirm that location-related variables (latitude/longitude), area-related variables (living and lot area), and house quality indicators (grade/condition) are the strongest drivers of price.
...
- **RQ4 Answer**: Data preprocessing and feature engineering (outlier removal, scaling, and derived features such as house age) improved model stability and reduced prediction error, contributing to higher R² and lower RMSE.
